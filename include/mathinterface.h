#ifndef MATHINTERFACELIB_HDR
#define MATHINTERFACELIB_HDR
...
namespace MathInterfaceLib {
   typedef enum {
      ...
      #endif
      #if !defined(MATHINTERFACELIB_PREFER_STATIC_ERRORS) || (defined(MATHINTERFACELIB_PREFER_STATIC_ERRORS) && defined(HAS_EIGEN))
        ENGINE_EIGEN,
      #endif
   ...
   //MathInterfacelib Exception
     struct MathInterfacelibException : public std::runtime_error {
            MathInterfacelibException(std::string msg) : std::runtime_error(msg) {};
     };
   //Iterator
   ...
   //Function
     struct Function {
        ...
        //Data
          #ifdef MATHINTERFFACELIB_USE_CPP0x_FUNC_CALLBACK
   ...
   //State
     ...
     //Raw data interface - for arbitrary data types with a common interface (e.g. as per Data)
       template<class NAME_T> struct RawDataInterface {
         #ifdef MATHINTERFACELIB_USE_CPP0x_FUNC_CALLBACK
   ...
   //Operations
     ...
     //State-less
       ...
       //Vector
         ...
         //Guarded specialization
           ...
           template <class VAL_T, class OP> typename std::enable_if<!has_op<VAL_T, OP>::value, VV<VAL_T>>::type gOp(const VV<VAL_T> &x) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
           ...
           template <class VAL_T, class OP> typename std::enable_if<!has_op<VAL_T, OP>::value, VV<VAL_T>>::type gOp(const VV<VAL_T> &x, const VV<VAL_T> &y) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
           ...
           template <class VAL_T, class OP, class CONST_T> typename std::enable_if<!has_op<VAL_T, OP>::value, VV<VAL_T>>::type gOpConst(const VV<VAL_T> &x, const CONST_T y) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
           ...
           template <class VAL_T, class OP, class CONST_T> typename std::enable_if<!has_op<VAL_T, OP>::value, VV<VAL_T>>::type gOpConst(const CONST_T &x, const VV<VAL_T> &y) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
           ...
           template<class VAL_T, class OP> typename std::enable_if<!has_op<VAL_T, OP>::value, VV<VAL_T>>::type gOpElem(const VV<VAL_T> &x, const VV<VAL_T> &y) {throw MathInterfacelibException("Error trying to execute non-supported element-wise operation");}
           ...
           template<class VAL_T, class OP> typename std::enable_if<!has_op<VAL_T, OP>::value, VV<VAL_T>>::type gOpElem(const VV<VAL_T> &x) {throw MathInterfacelibException("Error trying to execute non-supported element-wise operation");}
           ...
           template<class VAL_T, class OP> typename std::enable_if<!has_op<VAL_T, OP>::value, double>::type gOpReduce(const VV<VAL_T> &x) {throw MathInterfacelibException("Error trying to execute non-supported reduction operation");}
         //Multiple select
           template<class VAL_T> VV<VAL_T> op(OPs o, const VV<VAL_T> &x, const VV<VAL_T> &y) {
             switch(o) {
              ...
              default:           throw MathInterfacelibException("Invalid OP, not binary vector function");
             }
           }
           template<class VAL_T> VV<VAL_T> op(OPs o, const VV<VAL_T> &x) {
             switch(o) {
              ...
              default:                throw MathInterfacelibException("Invalid OP, not unary vector function");
             }
           }
           ...
           template<class VAL_T, class CONST_T> VV<VAL_T> opConst(OPs o, const VV<VAL_T> &x, const CONST_T y) {
             switch(o) {
              ...
              default:                   throw MathInterfacelibException("Invalid OP, not vector-constant function");
             }
           }
           ...
           template<class VAL_T> VV<VAL_T> opElem(OPs o, const VV<VAL_T> &x, const VV<VAL_T> &y) {
             switch(o) {
              ...
              default:           throw MathInterfacelibException("Invalid element-wise OP, not binary vector function");
             }
           }
           template<class VAL_T> VV<VAL_T> opElem(OPs o, const VV<VAL_T> &x) {
             switch(o) {
              ...
              default:           throw MathInterfacelibException("Invalid element-wise OP, not unary vector function");
             }
           }
           ...
           template<class VAL_T> double opReduce(OPs o, const VV<VAL_T> &x) {
             switch(o) {
              ...
              default:           throw MathInterfacelibException("Invalid reduction OP, not unary vector function");
             }
           }
       //Matrix
         ...
         //Guarded specialization
           ...
           template<class VAL_T, class OP> typename std::enable_if<!has_op<VAL_T, OP>::value, MV<VAL_T>>::type gOp(const MV<VAL_T> &x) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
           ...
           template<class VAL_T, class OP> typename std::enable_if<!has_op<VAL_T, OP>::value, MV<VAL_T>>::type gOp(const MV<VAL_T> &x, const MV<VAL_T> &y) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
           ...
           template<class VVAL_T, class MVAL_T, class OP> typename std::enable_if<!has_op<VVAL_T, MVAL_T, OP>::value, MV<MVAL_T>>::type gOp(const MV<MVAL_T> &x, const VV<VVAL_T> &y) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
           ...
           template<class VVAL_T, class MVAL_T, class OP> typename std::enable_if<!has_op<VVAL_T, MVAL_T, OP>::value, MV<MVAL_T>>::type gOp(const VV<VVAL_T> &x, const MV<MVAL_T> &y) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
           ...
           template<class VAL_T, class OP, class CONST_T> typename std::enable_if<!has_op<VAL_T, OP>::value, MV<VAL_T>>::type gOpConst(const MV<VAL_T> &x, const CONST_T y) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
           ...
           template<class VAL_T, class OP, class CONST_T> typename std::enable_if<!has_op<VAL_T, OP>::value, MV<VAL_T>>::type gOpConst(const CONST_T &x, const MV<VAL_T> &y) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
           ...
           template<class VAL_T, class OP> typename std::enable_if<!has_op<VAL_T, OP>::value, MV<VAL_T>>::type gOpElem(const MV<VAL_T> &x, const MV<VAL_T> &y) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
           ...
           template<class VAL_T, class OP> typename std::enable_if<!has_op<VAL_T, OP>::value, MV<VAL_T>>::type gOpElem(const MV<VAL_T> &x) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
           ...
           template<class VAL_T, class OP> typename std::enable_if<!has_op<VAL_T, OP>::value, double>::type gOpReduce(const MV<VAL_T> &x) {throw MathInterfacelibException("Error trying to execute non-supported reduction operation");}
         //Multiple select
           template<class VAL_T> MV<VAL_T> op(OPs o, const MV<VAL_T> &x, const MV<VAL_T> &y) {
             switch(o) {
              ...
              case OPs::OP_OR:   return gOp<VAL_T, OP_T<OPs::OP_OR>>(x, y);
              case OPs::OP_XOR:  return gOp<VAL_T, OP_T<OPs::OP_XOR>>(x, y);
              default:           throw MathInterfacelibException("Invalid OP, not binary matrix-matrix function");
             }
           }
           template<class VVAL_T, class MVAL_T> MV<MVAL_T> op(OPs o, const MV<MVAL_T> &x, const VV<VVAL_T> &y) {
             switch(o) {
              ...
              default:           throw MathInterfacelibException("Invalid OP, not binary matrix-vector function");
             }
           }
           template<class VVAL_T, class MVAL_T> MV<MVAL_T> op(OPs o, const VV<VVAL_T> &x, const MV<MVAL_T> &y) {
             switch(o) {
              ...
              case OPs::OP_OR:   return gOp<VVAL_T, MVAL_T, OP_T<OPs::OP_OR>>(x, y);
              case OPs::OP_XOR:  return gOp<VVAL_T, MVAL_T, OP_T<OPs::OP_XOR>>(x, y);
              default:           throw MathInterfacelibException("Invalid OP, not binary vector-matrix function");
             }
           }
           ...
           template<class VAL_T> MV<VAL_T> op(OPs o, const MV<VAL_T> &x) {
             switch(o) {
              ...
              default:                throw MathInterfacelibException("Invalid OP, not unary matrix function");
             }
           }
           ...
           template<class VAL_T, class CONST_T> MV<VAL_T> opConst(OPs o, const MV<VAL_T> &x, const CONST_T y) {
             switch(o) {
              ...
              default:                   throw MathInterfacelibException("Invalid OP, not binary matrix-constant function");
             }
           }
           ...
           template<class VAL_T> MV<VAL_T> opElem(OPs o, const MV<VAL_T> &x, const MV<VAL_T> &y) {
             switch(o) {
              ...
              case OPs::OP_MIN:   return gOpElem<VAL_T, OP_T<OPs::OP_MIN>>(x, y);
              case OPs::OP_MAX:   return gOpElem<VAL_T, OP_T<OPs::OP_MAX>>(x, y);
              default:           throw MathInterfacelibException("Invalid element-wise OP, not binary matri function");
             }
           }
           template<class VAL_T> MV<VAL_T> opElem(OPs o, const MV<VAL_T> &x) {
             switch(o) {
              case OPs::OP_SQRT:  return gOpElem<VAL_T, OP_T<OPs::OP_SQRT>>(x);
              case OPs::OP_ABS:   return gOpElem<VAL_T, OP_T<OPs::OP_ABS>>(x);
              default:           throw MathInterfacelibException("Invalid element-wise OP, not unary matri function");
             }
           }
       ...
       template<class VAL_T> class VV {
         ...
         public:
           ...
           //Functions
             ...
             template<class MVALT_T> MV<MVALT_T> toMatrix() const {return MathInterfaceLib::toMatrix<VAL_T, MVALT_T>(*this);}
             template<class MVALT_T> MV<MVALT_T> toDiagonalMatrix() const {return MathInterfaceLib::toDiagonalMatrix<VAL_T, MVALT_T>(*this);}  
             VV<VAL_T> clone() const {return MathInterfaceLib::clone<VAL_T>(*this);}
             void appendRows(const VV<VAL_T> &app) {return MathInterfaceLib::append<VAL_T>(*this, app);}
             void appendColumns(const VV<VAL_T> &app) {return MathInterfaceLib::append<VAL_T>(*this, app);}
             size_t numDims() const {return 1;}
             size_t size() const {return (size(0) * size(1));}
             size_t size(size_t dim) const {return MathInterfaceLib::size<VAL_T>(*this, dim);} 
       ...
       template<class VAL_T> class MV {
         ...
         public:
           ...
           //Functions
             ...
             MV<VAL_T> clone() const {return MathInterfaceLib::clone<VAL_T>(*this);}
             void appendRows(const MV<VAL_T> &app) {MathInterfaceLib::appendRows<VAL_T>(*this, app);}
             void appendColumns(const MV<VAL_T> &app) {MathInterfaceLib::appendColumns<VAL_T>(*this, app);}
             template<class VVALT_T> void appendRow(const VV<VVALT_T> &app) {MathInterfaceLib::appendRow<VAL_T, VVALT_T>(*this, app);}
             template<class VVALT_T> void appendColumn(const VV<VVALT_T> &app) {MathInterfaceLib::appendColumn<VAL_T, VVALT_T>(*this, app);}
     ...
     //State based
       ...
       //Guarded specialization
         ...
         template <class STATE_T, class OP> typename std::enable_if<!state_has_op<STATE_T, OP>::value, bool>::type
         gOpState(STATE_T &s, const NAME_T<STATE_T> dst, const NAME_T<STATE_T> src) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
         ...
         template <class STATE_T, class OP> typename std::enable_if<!state_has_op<STATE_T, OP>::value, bool>::type
         gOpState(STATE_T &s, const NAME_T<STATE_T> dst, const NAME_T<STATE_T> src0, const NAME_T<STATE_T> src1) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
         ...
         template <class STATE_T, class OP, class CONST_T> typename std::enable_if<!state_has_op<STATE_T, OP>::value, bool>::type
         gOpConstState(STATE_T &s, const NAME_T<STATE_T> dst, const NAME_T<STATE_T> src0, const CONST_T src1) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
         ...
         template <class STATE_T, class OP, class CONST_T> typename std::enable_if<!state_has_op<STATE_T, OP>::value, bool>::type
         gOpConstState(STATE_T &s, const NAME_T<STATE_T> dst, const CONST_T src0, const NAME_T<STATE_T> src1) {throw MathInterfacelibException("Error trying to execute non-supported operation");}
         ...
         template <class STATE_T, class OP> typename std::enable_if<!state_has_op<STATE_T, OP>::value, bool>::type
         gOpElemState(STATE_T &s, const NAME_T<STATE_T> dst, const NAME_T<STATE_T> src0, const NAME_T<STATE_T> src1) {throw MathInterfacelibException("Error trying to execute non-supported element-wise operation");}

         template <class STATE_T, class OP> typename std::enable_if<state_has_op<STATE_T, OP>::value, bool>::type
         gOpElemState(STATE_T &s, const NAME_T<STATE_T> dst, const NAME_T<STATE_T> src) {return opElem<STATE_T, OP>(s, dst, src);}
         template <class STATE_T, class OP> typename std::enable_if<!state_has_op<STATE_T, OP>::value, bool>::type
         gOpElemState(STATE_T &s, const NAME_T<STATE_T> dst, const NAME_T<STATE_T> src) {throw MathInterfacelibException("Error trying to execute non-supported element-wise operation");}

         template <class STATE_T, class OP> typename std::enable_if<state_has_op<STATE_T, OP>::value, bool>::type
         gOpReduceState(STATE_T &s, const NAME_T<STATE_T> dst, const NAME_T<STATE_T> src) {return opReduce<STATE_T, OP>(s, dst, src);}
         template <class STATE_T, class OP> typename std::enable_if<!state_has_op<STATE_T, OP>::value, bool>::type
         gOpReduceState(STATE_T &s, const NAME_T<STATE_T> dst, const NAME_T<STATE_T> src) {throw MathInterfacelibException("Error trying to execute non-supported reduce operation");}
       //Multiple select
         ...
         template<class STATE_T, class CONST_T> bool opConst(OPs o, STATE_T &s, const NAME_T<STATE_T> dst, const CONST_T &src0, const NAME_T<STATE_T> src1) {
           switch(o) {
            case OPs::OP_SCALE:        return gOpConstState<STATE_T, OP_T<OPs::OP_SCALE>>(s, dst, src0, src1);
            case OPs::OP_TRANSLATE:    return gOpConstState<STATE_T, OP_T<OPs::OP_TRANSLATE>>(s, dst, src0, src1);
            default:                   throw MathInterfacelibException("Invalid OP, not binary constant-matrix function");
           }
         }
         ...
         template<class STATE_T> bool opElem(OPs o, STATE_T &s, const NAME_T<STATE_T> dst, const NAME_T<STATE_T> src0, const NAME_T<STATE_T> src1) {
           switch(o) {
            ...
            default:                   throw MathInterfacelibException("Invalid element-wise OP, not binary function");
           }
         }
         template<class STATE_T> bool opElem(OPs o, STATE_T &s, const NAME_T<STATE_T> dst, const NAME_T<STATE_T> src) {
           switch(o) {
            ...
            default:                   throw MathInterfacelibException("Invalid element-wise OP, not unary function");
           }
         }
